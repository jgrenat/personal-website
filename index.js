...
function javascript$1(hljs) {
    ...
    variants: [
      ...
      },
      {
        match: [
          /extends/,
          /\s+/,
          concat$2(IDENT_RE$1$1, "(", concat$2(/\./, IDENT_RE$1$1), ")*")
        ],
        scope: {
          1: "keyword",
  ...
  const FUNCTION_CALL = {
    match: concat$2(
      ...
      IDENT_RE$1$1, lookahead$1(/\(/)),
    className: "title.function",
    relevance: 0
  };

  const PROPERTY_ACCESS = {
    begin: concat$2(/\./, lookahead$1(
      concat$2(IDENT_RE$1$1, /(?![0-9A-Za-z$_(])/)
    )),
    end: IDENT_RE$1$1,
    excludeBegin: true,
    keywords: "prototype",
  ...
  return {
    ...
    contains: [
      ...
      {
        className: 'attr',
        begin: IDENT_RE$1$1 + lookahead$1(':'),
        relevance: 0
      },
      FUNCTION_VARIABLE,
      { // "value" container
...
var indexTemplate = {
  load: async function (elmLoaded) {
    ...
    app.ports.highlightCode.subscribe(() => {
      setTimeout(() => core.highlightAll(), 100);
    });
  },
  flags: function () {
...
core.registerLanguage('js', javascript_1);
core.registerLanguage('bash', bash_1);
core.registerLanguage('java', java_1);
core.registerLanguage('haskell', haskell_1);
core.registerLanguage('idris', ocaml_1);
core.registerLanguage('markdown', ocaml_1);
